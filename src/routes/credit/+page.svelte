    ...
    <div class="grid grid-cols-1">
        <div class="m-3">
            ...
            <ul class="text-xs sm:text-sm md:text-md lg:text-lg">
                ...
                <li>Vectors and Icons by <a class="transition-colors font-extrabold no-underline duration-300 hover:text-sky-400" href="https://www.svgrepo.com" rel="noopener noreferrer" target="_blank">SVG Repo</a></li>
                <li>Background Music by <a class="transition-colors font-extrabold duration-300 hover:text-sky-400" href="https://pmmusic.pro/downloads/" rel="noopener noreferrer" target="_blank">PM Music</a></li>
            </ul>
        </div>
        ...
        <div class="m-3">
            ...
            <ul class="text-xs sm:text-sm md:text-md lg:text-lg">
                ...
                <li>Website Structure from <a class="transition-colors font-extrabold duration-300 hover:text-sky-400" href="https://www.sharyap.com/" rel="noopener noreferrer" target="_blank">Sharlene Yap</a></li>
                <li>Website Structure from <a class="transition-colors font-extrabold duration-300 hover:text-sky-400" href="https://lynnandtonic.com/" rel="noopener noreferrer" target="_blank">Lynn Fisher</a></li>
            </ul>
        </div>
    </div>
</div>